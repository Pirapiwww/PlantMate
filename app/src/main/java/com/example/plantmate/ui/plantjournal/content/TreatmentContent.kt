...
fun TreatmentContent(data: TreatmentEntity) {
    ...
    LabelValue(stringResource(id = R.string.plant_condition), data.plantCondition)
    LabelValue(stringResource(id = R.string.treatment_type), data.treatmentType)

    Spacer(modifier = Modifier.height(8.dp))

    LongText(stringResource(id = R.string.problem), data.problem)
    Spacer(modifier = Modifier.height(8.dp))
    LongText(stringResource(id = R.string.solution), data.solution)
